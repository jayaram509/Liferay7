...
public interface StudentLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Student> getStudentsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student fetchStudentByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Student getStudentByUuidAndGroupId(java.lang.String uuid,
