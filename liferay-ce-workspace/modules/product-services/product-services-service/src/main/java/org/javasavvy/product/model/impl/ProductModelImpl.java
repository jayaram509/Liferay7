...
import org.javasavvy.product.model.ProductModel;
...
/**
 * The base model implementation for the Product service. Represents a row in the &quot;pr_Product&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ProductModelImpl extends BaseModelImpl<Product>
	 ...
	 */
	public static final String TABLE_NAME = "pr_Product";
	...
	public static final String TABLE_SQL_CREATE = "create table pr_Product (uuid_ VARCHAR(75) null,productId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table pr_Product";
	public static final String ORDER_BY_JPQL = " ORDER BY product.createDate ASC";
	public static final String ORDER_BY_SQL = " ORDER BY pr_Product.createDate ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(org.javasavvy.product.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.org.javasavvy.product.model.Product"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(org.javasavvy.product.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.org.javasavvy.product.model.Product"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(org.javasavvy.product.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.org.javasavvy.product.model.Product"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(org.javasavvy.product.service.util.PropsUtil.get(
				"lock.expiration.time.org.javasavvy.product.model.Product"));
	...
	public int compareTo(Product product) {
		...
		value = DateUtil.compareTo(getCreateDate(), product.getCreateDate());
	...
	public String toXmlString() {
		...
		sb.append("org.javasavvy.product.model.Product");
