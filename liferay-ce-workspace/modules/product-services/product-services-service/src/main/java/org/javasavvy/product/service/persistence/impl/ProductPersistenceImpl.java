...
package org.javasavvy.product.service.persistence.impl;
...
import org.javasavvy.product.exception.NoSuchProductException;
import org.javasavvy.product.model.Product;
import org.javasavvy.product.model.impl.ProductImpl;
import org.javasavvy.product.model.impl.ProductModelImpl;
import org.javasavvy.product.service.persistence.ProductPersistence;
 ...
 * @see org.javasavvy.product.service.persistence.ProductUtil
 * @generated
 */
@ProviderType
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ProductModelImpl.ENTITY_CACHE_ENABLED,
			...
			ProductModelImpl.CREATEDATE_COLUMN_BITMASK);
	...
	protected Product getByCompanyId_PrevAndNext(Session session,
		Product product, long companyId,
		OrderByComparator<Product> orderByComparator, boolean previous) {
		StringBundler query = null;
