...
package org.javasavvy.product.service.persistence;
 ...
 * @see org.javasavvy.product.service.persistence.impl.ProductPersistenceImpl
 * @generated
 */
@ProviderType
public class ProductUtil {
	...
	*/
	public static Product findByUuid_First(java.lang.String uuid,
		OrderByComparator<Product> orderByComparator)
		throws org.javasavvy.product.exception.NoSuchProductException {
	...
	* @return the range of matching products
	*/
	public static List<Product> findByCompanyId(long companyId, int start,
		int end) {
	...
	* @throws NoSuchProductException if a matching product could not be found
	*/
	public static Product findByCompanyId_First(long companyId,
		OrderByComparator<Product> orderByComparator)
		throws org.javasavvy.product.exception.NoSuchProductException {
		return getPersistence()
	...
	* @return the first matching product, or <code>null</code> if a matching product could not be found
	*/
	public static Product fetchByCompanyId_First(long companyId,
		OrderByComparator<Product> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchProductException if a matching product could not be found
	*/
	public static Product findByCompanyId_Last(long companyId,
		OrderByComparator<Product> orderByComparator)
		throws org.javasavvy.product.exception.NoSuchProductException {
		return getPersistence()
	...
	* @return the last matching product, or <code>null</code> if a matching product could not be found
	*/
	public static Product fetchByCompanyId_Last(long companyId,
		OrderByComparator<Product> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchProductException if a product with the primary key could not be found
	*/
	public static Product[] findByCompanyId_PrevAndNext(long productId,
		long companyId, OrderByComparator<Product> orderByComparator)
		throws org.javasavvy.product.exception.NoSuchProductException {
		return getPersistence()
